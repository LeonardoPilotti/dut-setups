<x-layout>
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-white mb-2 mt-4">Configurar Setup para {{ $track->name }}</h1>
                ...
                <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input name="front_wing" type="number" min="0" max="50"
                        ...
                        <div>
                            ...
                            <input name="rear_wing" type="number" min="0" max="50"
                                class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                placeholder="0-50">
                        </div>
                    </div>
                ...
                <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input name="diff_on" type="number" min="10" max="100"
                                class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                placeholder="10-100%">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-2">Diferencial Inativo</label>
                            <input name="diff_off" type="number" min="10" max="100"
                                class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                placeholder="10-100%">
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Cambagem Traseira
                                    (°)</label>
                                <input name="rear_camber" type="number" step="0.1" type="number" min="-2.00" max="-1.00"
                                    class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                    placeholder="-2.00° a -1.00°">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Toe Traseiro (°)</label>
                                <input name="rear_toe" type="number" step="0.01" type="number" min="0.10" max="0.25"
                                    class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                ...
                <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input name="front_height" type="number" min="15" max="35"
                                class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                placeholder="15-35">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-2">Traseira</label>
                            <input name="rear_height" type="number" min="40" max="60"
                                class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                placeholder="40-60">
                        </div>
                    </div>
                ...
                <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input name="brake_pressure" type="number" min="80" max="100"
                                class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                placeholder="80-100%">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-2">Bias de Freio (%)</label>
                            <input name="brake_bias" type="number" step="1" min="50" max="70"
                                class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                placeholder="50-70%">
                        </div>
                    </div>

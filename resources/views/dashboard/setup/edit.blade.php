            ...
            <form action="{{ route('setups.update', ['track' => $track->slug, 'setup' => $setup->id]) }}" method="POST"
                ...
                <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700">
                    ...
                    <div>
                        ...
                        <select name="is_generic"
                            class="w-full px-3 py-2 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none">
                            <option value="0" {{ old('is_generic', $setup->is_generic) == 0 ? 'selected' : '' }}>
                                Setup da Equipe (Privado)</option>
                            <option value="1" {{ old('is_generic', $setup->is_generic) == 1 ? 'selected' : '' }}>
                                Setup Genérico (Público)</option>
                        </select>
                        @error('is_generic')
                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="bg-gray-800 p-6 rounded-2xl border border-gray-700">
                    ...
                    <select name="is_wet"
                        ...
                        <option value="0" {{ old('is_wet', $setup->is_wet) == 0 ? 'selected' : '' }}
                            class="bg-gray-800">Pista Seca</option>
                        <option value="1" {{ old('is_wet', $setup->is_wet) == 1 ? 'selected' : '' }}
                            class="bg-gray-800">Pista Molhada</option>
                    </select>
                    @error('is_wet')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input name="front_wing" type="number" min="0" max="50" step="1"
                                    required value="{{ old('front_wing', $setup->front_wing) }}"
                            ...
                            <div>
                                ...
                                <input name="rear_wing" type="number" min="0" max="50" step="1"
                                    required value="{{ old('rear_wing', $setup->rear_wing) }}"
                                    class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                    placeholder="0-50">
                                @error('rear_wing')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input name="front_suspension" type="number" min="1" max="41"
                                        required value="{{ old('front_suspension', $setup->front_suspension) }}"
                                        class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                        placeholder="1-41">
                                ...
                                <div>
                                    ...
                                    <input name="rear_suspension" type="number" min="1" max="41"
                                        required value="{{ old('rear_suspension', $setup->rear_suspension) }}"
                                        class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                        placeholder="1-41">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input name="front_anti_roll" type="number" min="1" max="21"
                                        required value="{{ old('front_anti_roll', $setup->front_anti_roll) }}"
                                        class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                        placeholder="1-21">
                                ...
                                <div>
                                    ...
                                    <input name="rear_anti_roll" type="number" min="1" max="21"
                                        required value="{{ old('rear_anti_roll', $setup->rear_anti_roll) }}"
                                        class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                        placeholder="1-21">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input name="brake_bias" type="number" step="1" min="50"
                                    max="70" required value="{{ old('brake_bias', $setup->brake_bias) }}"
                                    class="w-full px-4 py-3 rounded-xl bg-gray-900 text-white border border-gray-600 focus:outline-none"
                                    placeholder="50-70%">
                                @error('brake_bias')
                                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
